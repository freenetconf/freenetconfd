...
find_library(LIBDM_DMCLIENT_LIBRARY NAMES dm_dmclient libdm_dmclient
	HINTS ${PC_LIBDM_DMCLIENT_LIBDIR} ${PC_LIBDM_DMCLIENT_LIBRARY_DIRS})

set(LIBDMCONFIG_LIBRARIES ${LIBDMCONFIG_LIBRARY} ${LIBDM_DMCLIENT_LIBRARY})
set(LIBDMCONFIG_INCLUDE_DIRS ${LIBDMCONFIG_INCLUDE_DIR})

include(FindPackageHandleStandardArgs)

find_package_handle_standard_args(LIBDMCONFIG DEFAULT_MSG LIBDMCONFIG_LIBRARY LIBDM_DMCLIENT_LIBRARY LIBDMCONFIG_INCLUDE_DIR)

mark_as_advanced(LIBDMCONFIG_INCLUDE_DIR LIBDMCONFIG_LIBRARY LIBDM_DMCLIENT_LIBRARY)
